...
const RESULTS: Record<string, Partial<Match> & { home: string; away: string; homeScore: number; awayScore: number; homePens: number|null; awayPens: number|null; status: Match["status"]; stage: string; round: "group"|"knockout"; date: string }> = {
  ...
  "ko_qf_1":   { home:"France",       away:"Morocco",           homeScore:2, awayScore:0, homePens:null, awayPens:null, status:"FT", stage:"quarter",  round:"knockout", date:"2026-07-09" },
  "ko_qf_2":   { home:"Spain",        away:"Belgium",           homeScore:2, awayScore:1, homePens:null, awayPens:null, status:"FT", stage:"quarter",  round:"knockout", date:"2026-07-10" },
  "ko_qf_3":   { home:"Norway",       away:"England",           homeScore:1, awayScore:2, homePens:null, awayPens:null, status:"FT", stage:"quarter",  round:"knockout", date:"2026-07-11" },
  "ko_qf_4":   { home:"Argentina",    away:"Switzerland",       homeScore:3, awayScore:1, homePens:null, awayPens:null, status:"FT", stage:"quarter",  round:"knockout", date:"2026-07-12" },
  "ko_sf_1":   { home:"France",       away:"Spain",             homeScore:0, awayScore:2, homePens:null, awayPens:null, status:"FT", stage:"semi",     round:"knockout", date:"2026-07-14" },
  "ko_sf_2":   { home:"England",      away:"Argentina",         homeScore:1, awayScore:2, homePens:null, awayPens:null, status:"FT", stage:"semi",     round:"knockout", date:"2026-07-15" },
  "ko_3rd":    { home:"France",       away:"England",           homeScore:4, awayScore:6, homePens:null, awayPens:null, status:"FT", stage:"third-place", round:"knockout", date:"2026-07-18" },
};
